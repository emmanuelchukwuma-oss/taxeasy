# TaxEasy Go-To-Market Plan

## Positioning
TaxEasy is the simplest way for Nigerian earners to understand, pay, and prove tax compliance from bank-statement activity.

## Beachhead Segment
Start with Lagos freelancers, salary earners with side income, and small retailers who need tax proof for loans, business registrations, or public-sector documentation.
...
| Partner | Why They Care |
|---|---|
| SME lenders | TCC and payment history reduce compliance friction for loan applications |
| Fintech wallets/banks | Adds compliance value to existing transaction data |
| State revenue boards | Improves voluntary compliance without aggressive enforcement |
